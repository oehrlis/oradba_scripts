...
export TVDLDAP_DUMP_FILE_PREFIX=${TVDLDAP_DUMP_FILE_PREFIX:-$TVDLDAP_DEFAULT_DUMP_FILE_PREFIX}
export TVDLDAP_DUMP_FORMAT=${TVDLDAP_DUMP_FORMAT:-$TVDLDAP_DEFAULT_DUMP_FORMAT}
export TVDLDAP_ONE_DUMP_FILE=${TVDLDAP_ONE_DUMP_FILE:-$TVDLDAP_DEFAULT_ONE_DUMP_FILE}
